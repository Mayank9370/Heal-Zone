...
const Appointment = () => {
  ...
  const { doctors, currenctSymbol, backendUrl, token, getDoctorsData } = useContext(AppContext);
    ...
    docInfo && (
      <div>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          <button onClick={bookAppointment} className='bg-primary text-white text-2xl font-light px-10 py-3 rounded-full my-6'>Book an appoinment</button>
        </div>
